...
def generate_samples(num_samples, num_songs):
    ...
    for i in range(num_samples):
        ...
        rand_timestep = np.random.randint(steps_per_song/2-window_size, steps_per_song/2+window_size)
        rand_input = rand_song_inputs[rand_timestep-window_size:rand_timestep+window_size+1]
        rand_label = np.argmax(rand_song_labels[rand_timestep])
